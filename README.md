...
* [Visual Studio Code/Positron](https://github.com/quarto-dev/quarto) ⭐ 642 | 🐛 399 | 🌐 TypeScript | 📅 2026-09-03 - Extension for [Visual Studio Code/Positron](https://code.visualstudio.com/) to work with Quarto.
* [Positron](https://positron.posit.co/) - A next-generation extensible, polyglot data science IDE built by Posit PBC (support via [the Visual Studio Code extension for Quarto](https://github.com/quarto-dev/quarto) ⭐ 642 | 🐛 399 | 🌐 TypeScript | 📅 2026-09-03).
...
* [altdoc](https://github.com/etiennebacher/altdoc) ⭐ 86 | 🐛 23 | 🌐 R | 📅 2026-07-07 - Alternative to pkgdown to document R packages.
...
* [great-docs](https://github.com/posit-dev/great-docs) ⭐ 259 | 🐛 19 | 🌐 Python | 📅 2026-09-03 - Package from Posit that can be used to automatically generate a documentation site for a Python site, with a landing page, API reference and CLI reference, using Quarto as the rendering engine.
...
* [vale](https://github.com/vale-cli/vale) ⭐ 6,072 | 🐛 34 | 🌐 Go | 📅 2026-09-02 - Command-line tool that can be used to lint prose in Quarto markdown files, written in Go.
* [rumdl](https://github.com/rvben/rumdl) ⭐ 1,478 | 🐛 23 | 🌐 Rust | 📅 2026-09-03 - Markdown linter and formatter written in Rust.
* [LTeX+](https://github.com/ltex-plus/ltex-ls-plus) ⭐ 255 | 🐛 26 | 🌐 Kotlin | 📅 2026-09-02 - A LanguageTool-based grammar and spell-checking language server with support for Quarto alongside LaTeX, Markdown, and R Markdown.
* [Panache](https://github.com/jolars/panache) ⭐ 218 | 🐛 5 | 🌐 Rust | 📅 2026-09-03 - A language server, formatter, and linter for Markdown, Quarto, and R Markdown, built in Rust with a lossless CST parser and support for external formatters and linters on code blocks.
...
* [loom-lsp](https://github.com/PMassicotte/loom-lsp) ⭐ 4 | 🐛 0 | 🌐 Rust | 📅 2026-07-04 - A rust-based language server for Quarto documents, allowing IDE support for different languages within the same document.

## AI & LLMs

* [Quarto Agent Skills](https://github.com/posit-dev/skills) ⭐ 489 | 🐛 17 | 🌐 R | 📅 2026-08-28 - A collection of Claude/Agent Skills from Posit, including Quarto authoring, `brand.yml`, and alt text skills, that extend AI coding agents with Quarto-specific knowledge and workflows; usable from Claude Code, Claude.ai, and other agents (Cursor, Codex, Cline) via `npx skills add`.
...
* [quarto.org](https://github.com/quarto-dev/quarto-web) ⭐ 401 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-03 - The Quarto documentation website.
...
* [Noah Weidig's website](https://github.com/noahweidig/noahweidig.github.io) ⭐ 0 | 🐛 0 | 🌐 Astro | 📅 2026-09-04 - A single-page portfolio and blog with a custom light/dark theme (based on cosmo), an interactive 3D globe, and post-render scripts generating Open Graph cards.
...
* [Python for Data Analysis, 3E](https://github.com/wesm/pydata-book) ⭐ 24,879 | 🐛 31 | 🌐 Jupyter Notebook | 📅 2025-10-17 - "Python for Data Analysis" book third edition (see <https://wesmckinney.com/book/>).
...
* [R Packages, 2E](https://github.com/hadley/r-pkgs/) ⭐ 952 | 🐛 51 | 🌐 R | 📅 2026-09-04 - "R Packages" book second edition (see <https://r-pkgs.org/>).
...
* [Applied Machine Learning for Tabular Data](https://github.com/aml4td/website) ⭐ 170 | 🐛 30 | 🌐 HTML | 📅 2026-09-03 - An open textbook on tabular machine learning by Max Kuhn and Kjell Johnson, keeping the core text software-agnostic and decoupled from separate computing supplements (see <https://aml4td.org/>).
...
* [Quarto: The Practical Guide](https://github.com/mine-cetinkaya-rundel/quarto-tdg) ⭐ 62 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-04 - A concept-first guide to Quarto by Mine Çetinkaya-Rundel and Charlotte Wickham, complementing the official reference documentation (see <https://quarto-tdg.org/>).
